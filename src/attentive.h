...
class AttentiveConfigurator : public virtual FocusedConfigurator
{
  protected:
	...
	*/
    bool recycle_plan (vertexDescriptor v, vertexDescriptor &v0,
                       vertexDescriptor &task_start,
                       StateMatcher::MATCH_TYPE &matchType,
                       b2Transform &shift_start, b2Transform &sk_first_start,
                       std::pair<edgeDescriptor, bool> &edge,
                       std::vector<vertexDescriptor> &plan_prov,
                       Direction t_get_direction) override;
    ...
    std::pair<bool, vertexDescriptor> isPlannedTaskOK (vertexDescriptor src,
                                                       State s);
};
 ...
 */
    ...
    float customSimulationStep (vertexDescriptor v
                                = TransitionSystem::null_vertex ()) override
    {
